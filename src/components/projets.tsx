          ...
          <div className="flex flex-col lg:flex-row  border-2 border-card  rounded-3xl p-3 gap-5 ">
            ...
            <Card className=" w-full  lg:w-1/2 lg:mt-16 ">
             ...
             <CardContent className='text-xs text-muted-foreground'>
                ...
                <p>Le systeme pertmet aux résponsables de l'hotel de suivre facilement les réservations de leur clients car, les données sont centralisé sur Neon Database, et le systeme facilite la communication avec le client (l'emailing)</p>
                <br />
                <p>
                  Ce application a été développer avec NextJS, Spring Boot (REST FULL API). Elle est hébérgée sur Vercel, 
                </p>
             </CardContent>
           </Card>
